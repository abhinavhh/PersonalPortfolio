...
export const SKILLS_DATA = [
  {
    ...
    technologies: [
      ...
      { name: "Angular JS", level: 85, color: "from-red-500 to-red-600" },
    ],
  },
  {
    category: "Backend",
    technologies: [
      ...
      { name: "Django", level: 80, color: "from-red-500 to-purple-red" },
...
export const JOURNEY_DATA = [
  {
    ...
    description:
      "Began my journey in Computer Science, discovering my passion for programming and web development.",
    icon: BookOpen,
  },
  {
    year: "2022-2023",
    ...
    description:
      "Mastered programming fundamentals with Java, explored data structures and algorithms.",
    icon: Code,
  },
  {
    year: "2023-2024",
    ...
    description:
      "Dove deep into full-stack development, learned React, Node.js, and database management.",
    icon: Globe,
  },
  {
    year: "2025",
    ...
    description:
      "Graduated with strong technical skills and ready to contribute to innovative projects.",
    icon: Trophy,
  },
];
  ...
  goals: [
    {
      ...
      description:
        "Join a dynamic team where I can contribute to impactful projects while continuously learning and growing as a developer.",
      icon: Trophy,
    },
    {
      title: "Technical Excellence",
      description:
        "Master advanced full-stack technologies and contribute to open-source projects that benefit the developer community.",
      icon: Code,
    },
    {
      title: "Innovation Focus",
      description:
        "Work on cutting-edge projects that push the boundaries of what's possible in web development and user experience.",
      icon: Lightbulb,
    },
    {
      title: "Mentorship",
      description:
        "Eventually become a mentor to other aspiring developers, sharing knowledge and helping them grow in their careers.",
      icon: BookOpen,
    },
  ],
};
